...
public class MembresiaDAO {
	...
	public static boolean save(orm.Membresia membresia) throws PersistentException {
		try {
			orm.AdministracionContactosPersistentManager.instance().saveObject(membresia);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Membresia membresia) throws PersistentException {
		try {
			orm.AdministracionContactosPersistentManager.instance().deleteObject(membresia);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Membresia membresia)throws PersistentException {
		try {
			if (membresia.getContacto() != null) {
				membresia.getContacto().membresia.remove(membresia);
			}
			
			if (membresia.getGrupo() != null) {
				membresia.getGrupo().membresia.remove(membresia);
			}
	...
	public static boolean refresh(orm.Membresia membresia) throws PersistentException {
		try {
			orm.AdministracionContactosPersistentManager.instance().getSession().refresh(membresia);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Membresia membresia) throws PersistentException {
		try {
			orm.AdministracionContactosPersistentManager.instance().getSession().evict(membresia);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
