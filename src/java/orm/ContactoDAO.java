...
public class ContactoDAO {
	...
	public static boolean save(orm.Contacto contacto) throws PersistentException {
		try {
			orm.AdministracionContactosPersistentManager.instance().saveObject(contacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Contacto contacto) throws PersistentException {
		try {
			orm.AdministracionContactosPersistentManager.instance().deleteObject(contacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Contacto contacto)throws PersistentException {
		try {
			...
			for(int i = 0; i < lNotificacion_leidas.length; i++) {
				lNotificacion_leidas[i].setContacto(null);
			}
	...
	public static boolean refresh(orm.Contacto contacto) throws PersistentException {
		try {
			orm.AdministracionContactosPersistentManager.instance().getSession().refresh(contacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Contacto contacto) throws PersistentException {
		try {
			orm.AdministracionContactosPersistentManager.instance().getSession().evict(contacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
